...
public class ReadRequest {
	...
	private final static String folderDirectory = "/mnt/test/RandomFolder/words.txt";
	...
	private static void handleConnection(Socket connection) {
		...
		try {
			...
			while (true) {
				...
				if(tokens[0].contains("GET") && tokens[1].contains(folderDirectory) && (tokens[2].contains("HTTP/1.1") || tokens[2].contains("HTTP/1.1")) && counter == 1) {
